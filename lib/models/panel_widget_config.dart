...
class PanelWidgetConfig extends HiveObject {
  ...
  @HiveField(20)
  int? mapMarkerIcon; // Icon number 1-21 untuk Map Tracker
  @HiveField(21)
  ...
  bool isJsonPayload;
  @HiveField(25)
  String? jsonPath; // For Subscribe
  @HiveField(26)
  String? jsonPattern; // For Publish
  @HiveField(27)
  int decimalPlaces; // 0 = integer, 1-2 = float precision
